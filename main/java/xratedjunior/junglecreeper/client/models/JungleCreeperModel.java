package xratedjunior.junglecreeper.client.models;
...
@OnlyIn(Dist.CLIENT)
public class JungleCreeperModel<T extends Entity> extends SegmentedModel<T> {
   ...
   public JungleCreeperModel() {
      this(0.0F);
   }

   public JungleCreeperModel(float p_i46366_1_) {
      int i = 6;
